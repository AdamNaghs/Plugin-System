...
void core_init(Core* core, int version, char* plugin_folder)
{
    ...
    int *should_run = CTX_ALLOC(&core->context,"CORE_SHOULD_RUN",sizeof(int));
    *should_run = 1;
